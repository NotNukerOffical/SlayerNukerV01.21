...
# Initialize Firebase
cred = credentials.Certificate("main/auth/auth.json")
firebase_admin.initialize_app(cred)

if os.stat("main/auth/token.json").st_size == 0:
    # If the file is empty, prompt the user to input their token
    authtoken = input("Please enter your auth token: ")
    # Save the token to the file
    with open('main/auth/token.json', 'w') as f:
        json.dump({'authtoken': authtoken}, f)
else:
    with open('main/auth/token.json', 'r') as f:
...
print("Loading Moudules")
time.sleep(4)
print("Loading DataBase")
time.sleep(5)
print("Loaded The Bot Is Ready")
time.sleep(3)
...
Slayer_art = """
                                    ...
                                    ╱╱╱╱╱╱╱╱╱╱╱╱╭━╯┃
                                    ╱╱╱╱╱╱╱╱╱╱╱╱╰━━╯
                               *Future Of MassBan And Fastest Nuker*
                              ═══════════════════════════════════         
                         ═════════════════════════════════════════════
""".format("\x1b[38;5;17m", "\x1b[38;5;18m", "\x1b[38;5;19m", "\x1b[38;5;20m", "\x1b[38;5;51m", "\x1b[0m")
options = """
...
""".format("\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m",
           "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", 
           "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m",
           "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m")
...
class Slayer:
    ...
    def execute_ban(self, guildid: str, member: str, token: str):
        ...
        while True:
            ...
            if response.status_code in [200, 201, 204]:
                print("{}({}+{}) Banned {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", member))
    ...
    def execute_kick(self, guildid: str, member: str, token: str):
        while True:
            ...
            if response.status_code in [200, 201, 204]:
                print("{}({}+{}) Kicked {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", member))
    ...
    def execute_prune(self, guildid: str, days: int, token: str):
        ...
        if response.status_code == 200:
            print("{}({}+{}) Pruned {}{}{} members".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", response.json()['pruned'], "\x1b[0m"))
    ...
    def execute_crechannels(self, guildid: str, channelsname: str, type: int, token: str):
        ...
        while True:
            ...
            if response.status_code == 201:
                print("{}({}+{}) Created {}#{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", channelsname))
    ...
    def execute_creroles(self, guildid: str, rolesname: str, token: str):
        ...
        while True:
            ...
            if response.status_code == 200:
                print("{}({}+{}) Created {}@{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", rolesname))
                self.roles.append(1)
                break
            elif "retry_after" in response.text:
                print("{}({}!{}) Ratelimited. Delayed {}{}{}s".format("\x1b[0m", "\x1b[38;5;208m", "\x1b[0m", "\x1b[38;5;208m", response.json()['retry_after'], "\x1b[0m"))
    ...
    def execute_delchannels(self, channel: str, token: str):
        while True:
            ...
            if response.status_code == 200:
                print("{}({}+{}) Deleted {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", channel))
    ...
    def execute_delroles(self, guildid: str, role: str, token: str):
        while True:
            ...
            if response.status_code == 204:
                print("{}({}+{}) Deleted {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", role))
    ...
    def execute_delemojis(self, guildid: str, emoji: str, token: str):
        while True:
            ...
            if response.status_code == 204:
                print("{}({}+{}) Deleted {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", emoji))
    ...
    def execute_massping(self, channel: str, content: str, token: str):
        while True:
            ...
            if response.status_code == 200:
                print("{}({}+{}) Spammed {}{}{} in {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", content, "\x1b[0m", "\x1b[38;5;51m", channel))
    ...
    def menu(self):
        os.system(f"cls & title Slayer Nuker ^| Authenticated as: {__client__.user.name}#{__client__.user.discriminator}")
        print(Slayer_art + options + "\n")
        ans = input("{}({}Slayer{}) Option{}:{} ".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m")) 
        
        if ans in ["1", "01"]:
            scrape = input("{}({}Slayer{}) Fetch IDs [Y/N]{}:{} ".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
            if scrape.lower() == "y":
                try:
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Banned {}/{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.banned), len(members)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Kicked {}/{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.kicked), len(members)))
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["3", "03"]:
            days = int(input("{}({}Slayer{}) Days{}:{} ".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m")))
            self.execute_prune(guildid, days, token)
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["4", "04"]:
            type = input("{}({}Slayer{}) Channels Type ['t', 'v']{}:{} ".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
            type = 2 if type == "v" else 0
            amount = int(input("{}({}Slayer{}) Amount{}:{} ".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m")))
            self.channels.clear()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Created {}/{} channels".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.channels), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Created {}/{} roles".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.roles), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Deleted {}/{} channels".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.channels), len(channels)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Deleted {}/{} roles".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.roles), len(roles)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Deleted {}/{} emojis".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.emojis), len(emojis)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Slayer{}) Spammed {}/{} messages".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", len(self.messages), amount))
            time.sleep(1.5)
            self.menu()
            ...
            try:
                ...
                if VERSION != check_version:
                    print("{}({}Slayer{}) You're using an outdated version!".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
                    webbrowser.open(f"")
                else:
                    print("{}({}Slayer{}) You're using the current version!".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
            except:
                print("{}({}Slayer{}) Couldn't reach the releases!".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
            ...
            print("{}({}Slayer{}) Thanks for using Slayer!".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
            time.sleep(1.5)
            os._exit(0)
...
@__client__.event
async def on_ready():
    print("{}({}Slayer{}) Authenticated as{}: {}{}".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", f"{__client__.user.name}#{__client__.user.discriminator}"))
    time.sleep(1.5)
    Slayer().menu()
...
if __name__ == "__main__":
    try:
        user = auth.get_user(authtoken)
        os.system("title Slayer Nuker ^| Authentication & mode con: cols=95 lines=25")
        guildid = input("{}({}Slayer{}) Guild ID{}:{} ".format("\x1b[0m", "\x1b[38;5;51m", "\x1b[0m", "\x1b[38;5;51m", "\x1b[0m"))
